...
correlations = True 
patientinfo = "Weight" # "Group", "Height" or "Weight"
...
if do_eigenvecplot:
    ...
    # n_eigen_toplot = 1 # must be < n_pca
        eigenvector_full = pca2.components_[n_eigen, :]
...
if do_reconstruction:
    ...
    X_reconstructed = X_pca[:, :n_pc_toreconstruct] @ pca2.components_[:n_pc_toreconstruct, :] + np.mean(X, axis=0, keepdims=True)
...
if correlations:
    ...
    for file in all_files:
        ...
        patientinfo_list.append(dic[patientinfo])
    ...
    if patientinfo == "Group": # Categorial
        pf.plot_pcvalues_2d_metacat(X_pca, pc_n1, pc_n2, patientinfo, patientinfo_list)
    else:
        pf.plot_pcvalues_2d_meta(X_pca, pc_n1, pc_n2,  patientinfo, patientinfo_list)
