...
# X = pef.get_vectorsarray(source_folder, pca_folder, details_str = pca_description, mask=maskYS, binary_mask=maskbin, recalculate= False)
# pca, X_pca, meta = pef.pca_patients(X, pca_folder, pca_description, normalize_rows=not maskbin, recalculate = False, max_pc_calc = max_pc_calc)
